...
public class HwpfTest {
    ...
    public void testReadByDoc() throws Exception {
        InputStream is = new FileInputStream("D:\\temp\\aa.doc");
...
//    this.insertInfo(range);
        ...
        doc.write(new FileOutputStream("D:\\temp\\aa1.doc"));
    ...
    private void printInfo(Bookmarks bookmarks, HWPFDocument doc) {
        ...
        for (int i=0; i<count; i++) {
            ...
            this.insertInfo(new Range(bookmark.getStart(), bookmark.getEnd(), doc));
        }
    }
