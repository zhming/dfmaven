...
public class StringUtils {
	 ...
	 * original password.
	 * <p>
	 * In BO Project, every time a user logs in, we simply take their
	 * plain text password, compute the hash, and compare the generated hash to
	 * the stored hash. Since it is almost impossible that two passwords will
	 * generate the same hash, we know if the user gave us the correct password
	 * or not. The only negative to this system is that password recovery is
	 * basically impossible. Therefore, a reset password method is used instead.
	 * 
	 * @param data
	...
	/**
	 * Replace one or more character with backslah \ Example: Samuel's become
	 * Samuel\'s
	 * 
	 * Creator: Samuel Franklin Email: sfranklin@sfranklin.com
	 * 
	...
	/**
	 * Add backslashquote replace < and > become & lt dan & gt Example: Frans\n
	 * become Frans<br>
	 * 
	 * Creator: Frans Thamura (frans@intercitra.com)
	 * 
